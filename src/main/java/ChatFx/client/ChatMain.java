package ChatFx.client;

import ChatFx.client.chat.ControllerChat;
import ChatFx.client.login.ControllerLogin;
import ChatFx.client.registration.RecoveryController;
import ChatFx.client.registration.RegController;
...
public class ChatMain  extends Application {
    ...
    private void sceneInitialization() throws IOException{
        ...
        Parent rootLogin = loaderLogin.load(getClass()
                .getResourceAsStream("/resourcesChatFx/resourcesLogin/loginPanel.fxml"));
        ...
        Parent rootRegistration = loaderRegistration.load(getClass()
                .getResourceAsStream("/resourcesChatFx/resourcesReg/registration.fxml"));
        ...
        Parent rootChat = loaderChat.load(getClass()
                .getResourceAsStream("/resourcesChatFx/resourcesChat/chatPanel.fxml"));
        ...
        Parent rootRecovery = loaderRecovery.load(getClass()
                .getResourceAsStream("/resourcesChatFx/resourcesReg/passRecovery.fxml"));
